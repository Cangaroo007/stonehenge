...
function CameraIcon({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
      ...
      <path fillRule="evenodd" d="M9.344 3.071a49.52 49.52 0 015.312 0c.967.052 1.83.585 2.332 1.39l.821 1.317c.24.383.645.643 1.11.71.386.054.77.113 1.152.176 1.432.236 2.429 1.493 2.429 2.909V18a3 3 0 01-3 3H4.5a3 3 0 01-3-3V9.574c0-1.416.997-2.673 2.429-2.909.382-.063.766-.122 1.152-.176a1.56 1.56 0 001.11-.71l.822-1.318a2.652 2.652 0 012.33-1.39zM6.75 12.75a5.25 5.25 0 1110.5 0 5.25 5.25 0 01-10.5 0zm12-2.25a.75.75 0 100-1.5.75.75 0 000 1.5z" clipRule="evenodd" />
    </svg>
  );
}
...
const navItems = [
  ...
  { href: '/field/jobs', label: 'Jobs', icon: BriefcaseIcon },
  { href: '/field/capture', label: 'Capture', icon: CameraIcon },
  { href: '/field/settings', label: 'Settings', icon: CogIcon },
];
...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-zinc-950 border-t border-zinc-800 pb-[env(safe-area-inset-bottom)]">
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                'flex flex-col items-center justify-center min-w-[64px] min-h-[48px] py-2 px-3',
